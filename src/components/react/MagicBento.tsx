...
/** React Bits' MagicBento, retinted to the AI Nexus system.
 *  Logic is unchanged from upstream. What differs is the palette —
 *  paper cards, hairline borders, ink text, Nexus Indigo glow instead of
 *  the original's #120F17 cards and #8400ff purple — and the card data,
 *  which carries this company's proof points rather than the demo's. */
...
/** Nexus Indigo #2b46d4, not the upstream purple. */
const DEFAULT_GLOW_COLOR = '43, 70, 212';
...
const cardData: BentoCardProps[] = [
  {
    color: CARD_SURFACE,
    title: '48 AI agents',
    description: '11 MedOrbit · 20 Edvation · 10 AdvoHub · 7 TrustProperty',
    label: 'Agents'
  },
  {
    color: CARD_SURFACE,
  ...
  },
  {
    ...
    description: 'Including हिंदी, Marathi and Kannada',
    label: 'Reach'
  },
  {
    color: CARD_SURFACE,
...
const GlobalSpotlight: React.FC<{
  ...
  useEffect(() => {
    ...
    /* multiply, not screen: on a paper surface `screen` washes the
       spotlight out to nothing. */
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-2 select-none relative w-full"
    ...
    <>
      <style>
        {`
          ...
          .bento-section .card__label { color: #5f6c85; letter-spacing: 0.08em; text-transform: uppercase; font-weight: 600; }
          .bento-section .card__title { color: #0b1220; }
          .bento-section .card__description { color: #3d4a61; }
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(11, 18, 32, 0.08), 0 0 30px rgba(${glowColor}, 0.12);
          }
